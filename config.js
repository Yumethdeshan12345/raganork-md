...
module.exports = {
    ...
    SESSION: process.env.SESSION.trim() || 'Raganork~9532455de19cedb13ad887fae1aef169:772f63616154537a38466b3d',
    ...
    RBG_KEY: process.env.RBG_KEY || 'org-QAcY3Gg8e0BbOJaokh5YJut1',
    ...
    TAKE_KEY: process.env.TAKE_KEY || 'org-QAcY3Gg8e0BbOJaokh5YJut1'll,
    MODE: process.env.MODE || 'public',
    WARN: process.env.WARN || '4',
    ANTILINK_WARN: process.env.ANTILINK_WARN || '',
    HEROKU: {
        HEROKU: process.env.HEROKU === undefined ? false : convertToBool(process.env.HEROKU),
        API_KEY: process.env.HEROKU_API_KEY || 'org-QAcY3Gg8e0BbOJaokh5YJut1',
